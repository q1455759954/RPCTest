...
public class EsHandler {
     ...
     * 需要分词字段
     */
    private static List<String> ANALYZED_FIELD = Lists.newArrayList("title","content","nickname","text");
    /**
     * 集群名称cluster.name
     */
    public static final String ES_CLUSTER_NAME = "bigdata";
    /**
     * 主机IP
     */
    private static final String ES_HOST = "master";
    /**
     * 端口号
     */
